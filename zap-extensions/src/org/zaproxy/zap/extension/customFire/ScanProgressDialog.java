...
public class ScanProgressDialog extends AbstractDialog {
	 ...
	 * @param extension 
	 */
	public ScanProgressDialog(Frame owner, String site, ExtensionCustomFire extension) {
		super(owner, false);
	...
	private void initialize() {
		...
		if (mins > 0) {
			...
			tabbedPane.insertTab("ResponseCharts"
					, null, tab2, null, 1);
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setName("CustomFireScanProgressScrollPane");
	 ...
	 * @param scan the custom scan
	 */
	public void setCustomScan(CustomScan scan) {
		this.scan = scan;
