...
public class ScannerParam extends AbstractParam implements Serializable {
    ...
    private static final String HOST_PER_SCAN = CUSTOM_SCAN_BASE_KEY + ".hostPerScan";
    private static final String THREAD_PER_HOST = CUSTOM_SCAN_BASE_KEY + ".threadPerHost";
    // ZAP: Added support for delayInMs
    private static final String DELAY_IN_MS = CUSTOM_SCAN_BASE_KEY + ".delayInMs";
    private static final String INJECT_PLUGIN_ID_IN_HEADER = CUSTOM_SCAN_BASE_KEY + ".pluginHeader";
    private static final String HANDLE_ANTI_CSRF_TOKENS = CUSTOM_SCAN_BASE_KEY + ".antiCSFR";
    private static final String PROMPT_IN_ATTACK_MODE = CUSTOM_SCAN_BASE_KEY + ".attackPrompt";
    private static final String RESCAN_IN_ATTACK_MODE = CUSTOM_SCAN_BASE_KEY + ".attackRescan";
    private static final String PROMPT_TO_CLEAR_FINISHED = CUSTOM_SCAN_BASE_KEY + ".clearFinished";
    private static final String MAX_RESULTS_LIST = CUSTOM_SCAN_BASE_KEY + ".maxResults";
    private static final String MAX_SCANS_IN_UI = CUSTOM_SCAN_BASE_KEY + ".maxScansInUI";
    private static final String SHOW_ADV_DIALOG = CUSTOM_SCAN_BASE_KEY + ".advDialog";
    private static final String DEFAULT_POLICY = CUSTOM_SCAN_BASE_KEY + ".defaultPolicy";
    private static final String ATTACK_POLICY = CUSTOM_SCAN_BASE_KEY + ".attackPolicy";
    private static final String ALLOW_ATTACK_ON_START = CUSTOM_SCAN_BASE_KEY + ".attackOnStart";
    private static final String MAX_CHART_TIME_IN_MINS = CUSTOM_SCAN_BASE_KEY + ".chartTimeInMins";

    // ZAP: Excluded Parameters
    private static final String EXCLUDED_PARAMS_KEY = CUSTOM_SCAN_BASE_KEY + ".excludedParameters";
    ...
    private static final String TARGET_INJECTABLE = CUSTOM_SCAN_BASE_KEY + ".injectable";
    private static final String TARGET_ENABLED_RPC = CUSTOM_SCAN_BASE_KEY + ".enabledRPC";
     ...
     */
    private static final String SCAN_HEADERS_ALL_REQUESTS = CUSTOM_SCAN_BASE_KEY + ".scanHeadersAllRequests";
